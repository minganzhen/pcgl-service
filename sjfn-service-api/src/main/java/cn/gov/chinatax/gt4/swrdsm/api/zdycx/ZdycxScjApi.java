...
@FeignClient(value = "sjfn-service", contextId = "ZdycxScjApi", path = "/sjfn/api/zdycx-scj")
public interface ZdycxScjApi {
    ...
    public ServerResponse<PageResult<ZdycxScjDto>> getZdycxScjs(@RequestBody ZdycxScjQueryDto form);
